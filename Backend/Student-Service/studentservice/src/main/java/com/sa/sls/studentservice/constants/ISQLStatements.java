package com.sa.sls.studentservice.constants;
...
// Get Applicant by Application Id
	...
	public static final String UPDATE_LOAN_OFFER_STATUS = "UPDATE LOAN_OFFER SET OFFER_STATUS = ?, DISBURSED_DATE = SYSDATE WHERE OFFER_ID = ?";
